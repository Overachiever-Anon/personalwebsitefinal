        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-8">
            ...
            <AdminTile title="Gameplay Clips" items={gameplayItems} addLink="/admin/new-gameplay" sectionSlug="gameplay" tableName="gameplay_items" />
                        <Link href="/admin/homepage" className="bg-background/60 backdrop-blur-sm border border-border/50 rounded-xl p-6 hover:bg-background/70 transition-all duration-200 flex flex-col items-center justify-center text-center">
